import { AstrologyAIComponent } from './components/AstrologyAI-external/AstrologyAI-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, AstrologyAIComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, AstrologyAIComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
